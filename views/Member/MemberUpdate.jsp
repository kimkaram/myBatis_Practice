<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" errorPage="./loginMemberError.jsp" %>
...
<body>
<h1 align="center">
${loginloginMember.userName } 님의 회원 정보 수정페이지
</h1>
<form action="/testm/mupdate" method="post" onsubmit="return checkValidate();">
<table align="center" width="600" border="1">
<tr height="20"><th width="150" bgcolor="orange">아이디</th>
<td><input type="text" name="userid" 
value="${loginMember.userId }" readonly></td></tr>
<tr height="20"><th width="150" bgcolor="orange">이 름</th>
<td><input type="text" name="username" 
value="${loginMember.userName }"></td></tr>
<tr height="20"><th width="150" bgcolor="orange">암 호</th>
<td><input type="password" name="userpwd" id="userpwd"
value="${loginMember.userPwd }"></td></tr>
...
value="${loginMember.age }" min="19" max="150"></td></tr>
<tr height="20"><th bgcolor="orange">전화번호</th>
<td><input type="tel" name="phone" 
value="${loginMember.phone }"></td></tr>
<tr height="20"><th bgcolor="orange">이메일</th>
<td><input type="email" name="email" 
value="${loginMember.email }"></td></tr>
<tr height="20"><th bgcolor="orange">취 미</th>
<td>
<table>
<tr>
	<td width="150">
		<c:forTokens items="${loginMember.hobby }" delims="," var="s">
			<c:if test="${s eq 'game' }">
...
${loginMember.etc }</textarea></td></tr>
<tr height="20"><th bgcolor="orange">가입날짜</th>
<td><input type="date" name="enrolldate" 
value="${loginMember.enrollDate }" readonly></td></tr>
